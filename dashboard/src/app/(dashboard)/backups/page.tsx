  ...
  return (
    <div className="flex-1 flex flex-col min-h-screen">
      ...
      <div className="p-6 space-y-6 max-w-7xl mx-auto w-full">
        ...
        <div className="p-5 rounded-xl border border-emerald-500/30 bg-slate-900/60 flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
        ...
        <div className="rounded-xl border border-slate-800 bg-slate-900/40 overflow-hidden">
          <div className="p-4 border-b border-slate-800 flex items-center justify-between">
            <h3 className="font-bold text-white text-sm">Estado de Respaldo por Sitio</h3>
          </div>
              ...
              {sites.map((site) => (
                <tr key={site.id} className="hover:bg-slate-800/20">
                  ...
                  <td className="py-3.5 px-4">
                    <span className="font-semibold text-slate-200">UpdraftPlus v1.24</span>
                  </td>
